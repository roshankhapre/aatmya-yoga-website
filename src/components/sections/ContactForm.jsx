...
export default function ContactForm() {
  return (
    <>
      <Helmet>
        <title>
          Contact Aatmya Yoga | Yoga Classes & Teacher Training in Indore
        </title>
        <meta
          name="description"
          content="Get in touch with Aatmya Yoga for yoga classes, teacher training, and workshops in Indore. Call +91 82810 94117 or email yogasteni@gmail.com"
        />
        <link rel="canonical" href="https://www.aatmyayoga.com/contact" />
        <meta
          name="keywords"
          content="contact aatmya yoga, yoga classes indore, yoga teacher training contact, indore yoga studio"
        />
      </Helmet>
          ...
          <div className="grid md:grid-cols-2 gap-12 bg-white/80 backdrop-blur-sm p-8 md:p-10 rounded-2xl shadow-sm hover:shadow-md transition-all duration-500 border border-white/30">
            ...
            <div className="space-y-8">
              ...
              <p className="text-[#6d5b53] leading-relaxed">
                Our team responds with compassion and wisdom. Allow us to
                support your yoga journey with personalized attention.
              </p>
