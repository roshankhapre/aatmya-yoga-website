      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-6 py-3 bg-gradient-to-r from-[#9f7164] to-[#7a5a50] text-white font-light rounded-full shadow-sm hover:shadow-md transition-all duration-500">
              View Class Schedule
            </button>
            <button className="px-6 py-3 bg-white text-[#7a6359] font-light rounded-full border border-[#d8c3b6] hover:border-[#9f7164] hover:text-[#9f7164] shadow-sm hover:shadow-md transition-all duration-500">
              Book a Free Trial
            </button>
            <button className="px-6 py-3 bg-white text-[#7a6359] font-light rounded-full border border-[#d8c3b6] hover:border-[#9f7164] hover:text-[#9f7164] shadow-sm hover:shadow-md transition-all duration-500">
              Join a Workshop
            </button>
            <button className="px-6 py-3 bg-gradient-to-r from-[#5a4a42] to-[#44352d] text-white font-light rounded-full shadow-sm hover:shadow-md transition-all duration-500">
